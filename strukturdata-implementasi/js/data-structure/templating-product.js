import { recomendation } from "./modules/recomendation.js";
import { allItems } from "./modules/data-product.js";

// pisah dan ambil id dari query string url
// http://127.0.0.1:5500/strukturdata-implementasi/product.html?id=2
const queryString = window.location.search;
const query = queryString.split("=");

const id = parseInt(query[1]);
...
function showProductRecomendation(id) {
  ...
  recomendation[id].map(function (item) {
    recomendationHTML += showRecomendationProduct(item);
    return item;
  });
